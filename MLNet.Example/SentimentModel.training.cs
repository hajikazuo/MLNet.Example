...
namespace MLNet_Example
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\Nilton\Projetos\MLNet.Example\MLNet.Example\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.38113406F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
